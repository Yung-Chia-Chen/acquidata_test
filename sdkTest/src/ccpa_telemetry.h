...
#define CCPA_CENTRAL_INTERFACE_ASSISTREQ 0x2940015U
...
typedef enum {
    ...
    CCPA_TELEMETRY_CHANGED_RIDER_TORQUE = 1U << 8,
    CCPA_TELEMETRY_CHANGED_MOTOR_RPM = 1U << 9,
    CCPA_TELEMETRY_CHANGED_MOTOR_TEMPERATURE = 1U << 10
...
typedef struct {
    ...
    bool riderTorqueValid;
    float riderTorqueNm;
    CCPA_TelemetrySource riderTorqueSource;
